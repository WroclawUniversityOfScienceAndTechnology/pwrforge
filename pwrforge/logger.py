...
def __get_logging_config() -> Tuple[int, int]:
    ...
    try:
        ...
        pwrforge_config: pwrforgeConfig = config.pwrforge
        console_log_level = logging.getLevelName(pwrforge_config.console_log_level)  # pylint: disable=no-member
        file_log_level = logging.getLevelName(pwrforge_config.file_log_level)  # pylint: disable=no-member
...
def get_logger(name: str = "pwrforge") -> logging.Logger:
