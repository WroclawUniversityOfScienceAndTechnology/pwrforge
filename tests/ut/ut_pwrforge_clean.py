...
from pwrforge.commands.clean import EXCLUDE_FROM_CLEAN, pwrforge_clean
...
def test_clean_build(
    ...
    monkeypatch.setattr("pwrforge.commands.clean.get_pwrforge_config_or_exit", lambda: config)
