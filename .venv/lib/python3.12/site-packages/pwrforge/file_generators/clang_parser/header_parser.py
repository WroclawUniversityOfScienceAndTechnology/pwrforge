...
from pwrforge.file_generators.clang_parser.data_classes import HeaderDescriptor
from pwrforge.file_generators.clang_parser.params_extractor import (
    extract_classes,
    extract_includes,
    extract_namespaces,
)
...
def parse_file(file_path: Path) -> HeaderDescriptor:
    ...
    return HeaderDescriptor(name=file_path.name, namespaces=namespaces, classes=classes, includes=includes)
